import 'controller/haburger_menu_controller.dart';
...
class HaburgerMenuDraweritem extends StatelessWidget {
  HaburgerMenuDraweritem(this.controller);

  HaburgerMenuController controller;
